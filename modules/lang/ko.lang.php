<?php
	 ...
	 * @author sol (sol@ngleader.com) / delphiXE (admin@folderfile.net) / 이온디(eond@eond.com, http://eond.com)
	...
	$lang->about_planet =
		"XE에서 제공하는 설치형 SNS(일명 microBlog) 모듈입니다. 회원별로 '플래닛'이라는 마이크로블로그를 생성하여 운영할 수 있습니다.
		홈페이지 패키지에서 사용되는 도메인으로는 플래닛이 접속이 안될 수도 있습니다.
		플래닛을 초기페이지로 설정할 경우 접속을 원하는 도메인을 홈페이지 패키지 등에서 사용하지 않아야 합니다.";
